...
#Create a Jenkinsfile at the root of your .NET project in the Git repository. Below is a simple but complete pipeline for a .NET project, including build, tests, linting, security scans, and code quality checks.
pipeline {
    agent any
